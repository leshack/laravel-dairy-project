                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form name="add_cow" id = "add_cow" method = "post" action="{{URL::to('cow/update/'.$cow->cow_id)}}" >
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="form-group">
                                        ...
                                        <input required type="text" class="form-control" id="cow_name" name="cow_name" value="{{$cow->cow_name}}">
                                    </div>
                                    <div class="form-group">
                                         <label for="birth_date">Birth Date</label>
                                         <input required type="date" class="form-control" name="birth_date" id="birth_date" value="{{$cow->birth_date}}">
                                    </div>
                                    <div class="form-group">
